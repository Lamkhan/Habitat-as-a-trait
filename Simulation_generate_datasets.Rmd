...
```{r}
model_range <- 1:10 #Set this at the beginning of each session, used to break up total runs over many sessions
...
```{r}
#This will pull file names from rds files, instead of results object
# Generate file names based on the model_range
...
print(causal_model_files)
print(bivariate_dh_model_files)
print(bivariate_model_files)
print(univar_model_files)
