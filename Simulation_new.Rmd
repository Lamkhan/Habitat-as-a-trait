...
```{r}
causal_summaries <- summarize_models(causal_model_files, path='C:\\Users\\Lam\\Desktop\\Lam Honors project runs\\Outputs_100_5\\model_cs_runs\\')
...
bivariate_dh_summaries <- summarize_models(bivariate_dh_model_files, path ="C:\\Users\\Lam\\Desktop\\Lam Honors project runs\\Outputs_100_5\\model_biv_dh_runs\\")
...
bivariate_summaries <- summarize_models(bivariate_model_files, path='C:\\Users\\Lam\\Desktop\\Lam Honors project runs\\Outputs_100_5\\model_biv_runs\\')
...
univariate_summaries <- summarize_models(univar_model_files, path='C:\\Users\\Lam\\Desktop\\Lam Honors project runs\\Outputs_100_5\\model_univar_runs\\')
...
path <- "C:\\Users\\Lam\\Desktop\\Lam Honors project runs\\Outputs_100_5\\Summaries\\"  # Set the directory where summary files are stored
...
# Define file paths
file_paths <- list(
  "50ind_10obs"  = "C:/Users/lamkh/Documents/Habitat as a trait Proj/Output_figures_all/Model_Output_fixed_effects_50ind10obs.rds",
  "100ind_5obs"  = "C:/Users/lamkh/Documents/Habitat as a trait Proj/Output_figures_all/Model_Output_fixed_effects_100ind5obs.rds",
  "100ind_10obs" = "C:/Users/lamkh/Documents/Habitat as a trait Proj/Output_figures_all/Model_Output_fixed_effects_100ind10obs.rds"
)
...
for (param in parameter_names) {
  ...
  # Extract and modify plots for each sample size
  plots_to_show <- map(plot_lists, function(plot_list) {
    ...
    plot +
      ...
      theme(
        ...
        axis.title.y = element_text(angle = 90, vjust = 1, hjust = 0.5),  # Rotate label vertically
  ...
  plots_to_show[[1]] <- plots_to_show[[1]] +
    ...
    theme(axis.title.y = element_text(angle = 90, vjust = 1, hjust = 0.5))  # Ensures vertical y-axis label
...
saveRDS(final_plot, file = "final_plot_fixed_effects.rds")
```
...
sd_file_paths <- list(
  "50ind_10obs"  = "C:\\Users\\lamkh\\Documents\\Habitat as a trait Proj\\Output_figures_all\\Model_Output_SD_50ind10obs.rds",
  "100ind_5obs"  = "C:\\Users\\lamkh\\Documents\\Habitat as a trait Proj\\Output_figures_all\\Model_Output_SD_100ind5obs.rds",
  "100ind_10obs" = "C:\\Users\\lamkh\\Documents\\Habitat as a trait Proj\\Output_figures_all\\Model_Output_SD_100ind10obs.rds"
)
...
for (param in sd_parameter_names) {
  ...
  # Extract plots for the current SD parameter across sample sizes
  plots_to_show <- map(sd_plot_lists, function(plot_list) {
    ...
    plot +
      ...
      geom_point(aes(color = model == "Causal"), size = 3) +
      geom_errorbar(aes(ymin = lower, ymax = upper, color = model == "Causal"), width = 0.2) +
      scale_color_manual(values = c("black", "blue")) +  # Blue for causal
      theme_minimal() +
      theme(
        plot.title = element_text(size = 10),
        axis.text.x = element_text(size = 9, angle = 45, hjust = 1),
...
# Save the final plot
saveRDS(final_plot, file = "final_plot_ran_effects.rds")
